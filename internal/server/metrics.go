...
// Metrics contains runtime statistics for the server
type Metrics struct {
...
// MetricsSnapshot represents a point-in-time view of server metrics
...
// GetSnapshot returns a consistent snapshot of current metrics
