...
Code at DigitalOcean is mostly written in Go and Ruby, but you should feel free to write your solution in any language you prefer. Although we use and write libraries at DigitalOcean, for this exercise we would like to see as much of your own code as possible, so we ask you **not to use any library apart from your chosen runtime's standard library**. Testing code and build tools might use libraries, but not production code.

We would also ask you to write code that you would consider production-ready, something you think other people would be happy supporting. Please don't forget to send us your automated tests and any other artifacts needed to develop, build, or run your solution.
...
* Source control history (e.g. the `.git` directory)
  * **It is very important to anonymize your commits. E.g. in git, add a .git/config file -- _before_ you make any commits -- such as:**
    ```
    [user]
        name="Anonymous"
